# Review Packet: agent_evidence-sample-run-live-envelope

## Decision
- Final status: `blocked`
- Reviewer action: Reject the run; the policy gate blocked trust even though verification passed.
- Adapter: `synthetic_sample`
- Provenance: `synthetic_live_envelope`
- Workflow: `live_preflight_envelope`
- Scope: modeled local coding-agent-style run
- Timeout and cost budget: recorded in `run_record.json`
- Failure capture: `input_rejected`
...
- Provider request blocked in preflight: `true`
- Redaction count: `4`
- Relevant artifacts: `samples/agent_evidence-sample-run-live-envelope/live_request_envelope.json, samples/agent_evidence-sample-run-live-envelope/live_redaction_report.json, samples/agent_evidence-sample-run-live-envelope/provider_request_rejection_record.json`
