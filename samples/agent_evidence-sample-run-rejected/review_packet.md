# Review Packet: agent_evidence-sample-run-rejected

## Decision
- Final status: `rejected`
- Reviewer action: Reject the run; keep the artifact bundle as evidence of the failed modeled change.
...
- Failure capture: `verifier_failure`
- Provider calls executed: `false`
- Reviewer outcome required: `false`
