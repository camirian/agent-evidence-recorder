# Evidence Packet: agent_evidence-sample-run-escalated

## Summary
- Final status: `needs_human_review`
- Recommended reviewer decision: `escalate`
...
- Failure class: `policy_review_required`
...
## Verification
- Result: The modeled edit passes verification but requires human review by policy.
